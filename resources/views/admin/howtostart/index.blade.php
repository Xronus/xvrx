    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="client_size" class="form-control @error('client_size') is-invalid @enderror" value="{{ old('client_size', $hts->client_size ?? '25.6 GB') }}" placeholder="25.6 GB">
                        @error('client_size')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><i class="ri-google-drive-line me-1"></i> Google Drive</td>
                                    <td><input type="text" name="google_drive_url" class="form-control form-control-sm @error('google_drive_url') is-invalid @enderror" value="{{ old('google_drive_url', $hts->google_drive_url ?? '') }}" placeholder="https://drive.google.com/..."></td>
                                    @error('google_drive_url')<tr class="table-danger"><td colspan="3"><div class="invalid-feedback d-block">{{ $message }}</div></td></tr>@enderror
                                ...
                                <tr>
                                    <td><i class="ri-cloud-line me-1"></i> Yandex Disk</td>
                                    <td><input type="text" name="yandex_disk_url" class="form-control form-control-sm @error('yandex_disk_url') is-invalid @enderror" value="{{ old('yandex_disk_url', $hts->yandex_disk_url ?? '') }}" placeholder="https://disk.yandex.ru/..."></td>
                                    <td class="text-center">
                                        <div class="form-check form-switch d-flex justify-content-center">
                                ...
                                <tr>
                                    <td><i class="ri-mail-line me-1"></i> FileMail</td>
                                    <td><input type="text" name="filemail_url" class="form-control form-control-sm @error('filemail_url') is-invalid @enderror" value="{{ old('filemail_url', $hts->filemail_url ?? '') }}" placeholder="https://filemail.com/..."></td>
                                    <td class="text-center">
                                        <div class="form-check form-switch d-flex justify-content-center">
                                ...
                                <tr>
                                    <td><i class="ri-download-cloud-2-line me-1"></i> MegaNZ</td>
                                    <td><input type="text" name="mega_url" class="form-control form-control-sm @error('mega_url') is-invalid @enderror" value="{{ old('mega_url', $hts->mega_url ?? '') }}" placeholder="https://mega.nz/..."></td>
                                    <td class="text-center">
                                        <div class="form-check form-switch d-flex justify-content-center">
                                ...
                                <tr>
                                    <td><i class="ri-magnet-line me-1"></i> Torrent File</td>
                                    <td><input type="text" name="torrent_url" class="form-control form-control-sm @error('torrent_url') is-invalid @enderror" value="{{ old('torrent_url', $hts->torrent_url ?? '') }}" placeholder="https://...torrent"></td>
                                    <td class="text-center">
                                        <div class="form-check form-switch d-flex justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label">{{ __('main.button_text') }}</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="launcher_url" class="form-control @error('launcher_url') is-invalid @enderror" value="{{ old('launcher_url', $hts->launcher_url ?? '') }}" placeholder="https://...">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">{{ __('main.launcher_description') }}</label>
