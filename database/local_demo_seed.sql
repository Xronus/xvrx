...
(2, '13.06.2026', 'Подготовка игрового клиента', 'Game client preparation', 'Раздел скачивания будет использовать данные старой таблицы how_to_start и сохранит удобный путь старта.', 'The download section will use the old how_to_start table and keep a convenient start flow.', 'xvrx-assets/images/bg_texture.jpg', NOW(), NOW()),
(3, '12.06.2026', 'Рейтинг арены и персонажей', 'Arena and character ladder', 'Ладдер подключается к characters DB и показывает арены, убийства и время игры.', 'The ladder connects to the characters DB and shows arenas, kills, and playtime.', 'xvrx-assets/images/hero.jpg', NOW(), NOW()),
...
(6, '09.06.2026', 'Подготовка личного кабинета', 'Account panel preparation', 'Личный кабинет получает единый визуальный стиль, разделы персонажей и голосования остаются подключенными к старой Laravel-схеме.', 'The account panel receives a unified visual style while characters and voting stay connected to the old Laravel schema.', 'xvrx-assets/images/bg_texture.jpg', NOW(), NOW()),
(7, '08.06.2026', 'Первые награды за активность', 'First activity rewards', 'Для тестового запуска готовятся бонусы за голосование, участие в проверках и первые найденные ошибки.', 'Test-launch rewards are being prepared for voting, participation, and first reported issues.', 'xvrx-assets/images/hero.jpg', NOW(), NOW())
ON DUPLICATE KEY UPDATE
  `date` = VALUES(`date`),
  `text` = VALUES(`text`),
...
(2, 'Личный кабинет', 'Account panel', 'Регистрация, персонажи, голосования и управление аккаунтом.', 'Registration, characters, voting, and account management.', 'xvrx-assets/images/bg_texture.jpg', 1, 2, NOW(), NOW()),
(3, 'PvP рейтинг', 'PvP ladder', 'Арена, убийства и время игры читаются из characters базы.', 'Arena, kills, and playtime are read from the characters database.', 'xvrx-assets/images/hero.jpg', 1, 3, NOW(), NOW())
ON DUPLICATE KEY UPDATE
