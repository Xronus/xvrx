...
@section('title', __('main.add_shop_item'))
@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">{{ __('main.add_shop_item') }}</h4>
                ...
                <form action="{{ route('admin.shop.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type_id" class="form-select @error('type_id') is-invalid @enderror" required>
                            ...
                            @foreach($types as $t)
                            <option value="{{ $t->id }}" {{ old('type_id') == $t->id ? 'selected' : '' }}>{{ $t->name_ru }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon_name" class="form-control @error('icon_name') is-invalid @enderror" value="{{ old('icon_name') }}" placeholder="inv_misc_questionmark" required>
